...
**Próximo paso sugerido**: (3) es una fila de `ActionRow` en `mas.tsx` (coordinar con quien lo posea); (2) preguntarle a Raf con opciones; (1) esperar al segundo driver.
...
## 2026-07-29 — `StickConnectionScreen`: el único `router.back()` pelado que queda en la app (ahora sí es deuda nuestra)
