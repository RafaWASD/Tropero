-- 0035_animal_timeline_v2.sql  (spec 02 lógico: 0034)
-- Reemplaza animal_timeline para incluir el séptimo origen 'observacion'
-- (animal_events, modelo Híbrido). event_date del origen = created_at.
-- Cubre R10.1 (extendido a 7 orígenes), R10.2.
