...
// desde node:test. Replica y ENDURECE el patrón del bridge E2E (`__RAFAQ_BLE_E2E__`): la marca la
...
const DEMO_GLOBAL_KEY = '__RAFAQ_BLE_DEMO__';
...
// del gate demo para poder ejercitar el simulador en la suite/captura. `__RAFAQ_BLE_DEMO_ALLOW_E2E__`
// es un override explícito (si es booleano, gana); si no está, se usa `__RAFAQ_BLE_E2E__ === true`.
const E2E_GLOBAL_KEY = '__RAFAQ_BLE_E2E__';
const E2E_DEMO_ALLOW_KEY = '__RAFAQ_BLE_DEMO_ALLOW_E2E__';
 ...
 * producción/preview → prod-safe. Override explícito `__RAFAQ_BLE_DEMO_ALLOW_E2E__` (si es booleano
 * gana); si no, se usa `__RAFAQ_BLE_E2E__ === true`. `typeof globalThis` guard (safe en node).
 */
 ...
 * (no tiene `__DEV__`, ni `extra.demoBuild`, ni `__RAFAQ_BLE_E2E__`).
 */
 ...
 *   (1) la marca global `__RAFAQ_BLE_DEMO__` está puesta deliberadamente ANTES del bundle, Y
