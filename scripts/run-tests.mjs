...
run(
  'client unit tests',
  `node --disable-warning=MODULE_TYPELESS_PACKAGE_JSON --test app/src/utils/validation.test.ts app/src/utils/auth-errors.test.ts app/src/utils/lockout.test.ts app/src/utils/establishment.test.ts app/src/utils/establishment-mapping.test.ts app/src/utils/invite.test.ts app/src/utils/account-result.test.ts app/src/utils/rodeo-template.test.ts app/src/utils/a11y.test.ts app/src/utils/animal-identifier.test.ts app/src/utils/animal-category.test.ts app/src/utils/animal-form.test.ts app/src/utils/animal-input.test.ts app/src/utils/last-rodeo.test.ts app/src/services/establishment-store.test.ts app/src/services/ble/parser-rs420.test.ts`,
);
