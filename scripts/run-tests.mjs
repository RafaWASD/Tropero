...
run(
  'client unit tests',
  `node --disable-warning=MODULE_TYPELESS_PACKAGE_JSON --import ./scripts/ts-ext-resolver.mjs --test app/src/utils/validation.test.ts app/src/utils/auth-errors.test.ts app/src/utils/lockout.test.ts app/src/utils/establishment.test.ts app/src/utils/establishment-mapping.test.ts app/src/utils/invite.test.ts app/src/utils/account-result.test.ts app/src/utils/rodeo-template.test.ts app/src/utils/a11y.test.ts app/src/utils/animal-identifier.test.ts app/src/utils/animal-category.test.ts app/src/utils/animal-category-picker.test.ts app/src/utils/animal-category-fields.test.ts app/src/utils/animal-birth-year.test.ts app/src/utils/animal-age.test.ts app/src/utils/group-actions.test.ts app/src/utils/animal-form.test.ts app/src/utils/animal-input.test.ts app/src/utils/event-timeline.test.ts app/src/utils/event-input.test.ts app/src/utils/bulk-candidates.test.ts app/src/utils/bulk-selection.test.ts app/src/utils/bulk-idempotency.test.ts app/src/utils/bulk-operations-plan.test.ts app/src/utils/castration-copy.test.ts app/src/utils/selection-display.test.ts app/src/utils/vaccination-preview.test.ts app/src/utils/sanitary-route.test.ts app/src/utils/last-rodeo.test.ts app/src/utils/eid-format.test.ts app/src/utils/nav.test.ts app/src/utils/management-group.test.ts app/src/utils/onboarding.test.ts app/src/utils/env-resolve.test.ts app/src/services/establishment-store.test.ts app/src/services/exit-animal.test.ts app/src/services/transfer-animal.test.ts app/src/services/tag-lookup.test.ts app/src/services/powersync/platform-select.test.ts app/src/services/powersync/upload-classify.test.ts app/src/services/powersync/status-derive.test.ts app/src/services/powersync/online-guard.test.ts app/src/services/powersync/first-sync.test.ts app/src/services/powersync/schema.test.ts app/src/services/powersync/local-reads.test.ts app/src/services/powersync/upload.test.ts app/src/services/ble/parser-rs420.test.ts app/src/services/ble/dedup.test.ts app/src/services/ble/contract.test.ts app/src/services/ble/feedback.test.ts app/src/services/ble/adapter-mock.test.ts app/src/services/ble/adapter-web-serial.test.ts app/src/services/ble/wiring.test.ts app/src/services/ble/offline-noread.test.ts app/src/utils/import/parse-csv.test.ts app/src/utils/import/parse-sigsa-txt.test.ts app/src/utils/import/breed-senasa.test.ts app/src/utils/import/column-mapping.test.ts app/src/utils/import/normalize-row.test.ts app/src/utils/import/validate-rows.test.ts app/src/utils/import/import-write.test.ts app/src/utils/import/parse-xlsx.test.ts app/src/utils/import/import-ui.test.ts`,
);
