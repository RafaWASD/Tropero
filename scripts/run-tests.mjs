...
run(
  ...
  // un guard que no corre da falsa confianza, que es peor que no tenerlo.
  `node --disable-warning=MODULE_TYPELESS_PACKAGE_JSON --import ./scripts/ts-ext-resolver.mjs --test app/src/utils/phone.test.ts app/src/components/phone-field-guard.test.ts app/src/services/classify-error.test.ts app/src/utils/validation.test.ts app/src/utils/auth-errors.test.ts app/src/utils/lockout.test.ts app/src/utils/establishment.test.ts app/src/utils/establishment-mapping.test.ts app/src/utils/sort-members.test.ts app/src/utils/invite.test.ts app/src/utils/account-result.test.ts app/src/utils/rodeo-template.test.ts app/src/utils/a11y.test.ts app/src/utils/animal-identifier.test.ts app/src/utils/animal-category.test.ts app/src/utils/animal-category-picker.test.ts app/src/utils/animal-category-fields.test.ts app/src/utils/animal-birth-year.test.ts app/src/utils/link-calf-query.test.ts app/src/utils/animal-age.test.ts app/src/utils/group-actions.test.ts app/src/utils/group-page-cursor.test.ts app/src/utils/group-view-model.test.ts app/src/utils/animal-form.test.ts app/src/utils/animal-input.test.ts app/src/utils/event-timeline.test.ts app/src/utils/event-input.test.ts app/src/utils/treatment-input.test.ts app/src/utils/calf-birth.test.ts app/src/utils/bulk-candidates.test.ts app/src/utils/bulk-selection.test.ts app/src/utils/bulk-idempotency.test.ts app/src/utils/bulk-operations-plan.test.ts app/src/utils/batch-exit-selection.test.ts app/src/utils/batch-exit-plan.test.ts app/src/utils/castration-copy.test.ts app/src/utils/cut-eligibility.test.ts app/src/utils/identifier-assign.test.ts app/src/services/cut-service-core.test.ts app/src/utils/selection-display.test.ts app/src/utils/vaccination-preview.test.ts app/src/utils/last-rodeo.test.ts app/src/utils/eid-format.test.ts app/src/utils/nav.test.ts app/src/utils/management-group.test.ts app/src/utils/onboarding.test.ts app/src/utils/env-resolve.test.ts app/src/utils/app-env.test.ts app/app.config.test.ts app/src/services/establishment-store.test.ts app/src/services/exit-animal.test.ts app/src/services/transfer-animal.test.ts app/src/services/tag-lookup.test.ts app/src/services/powersync/platform-select.test.ts app/src/services/powersync/upload-classify.test.ts app/src/services/powersync/status-derive.test.ts app/src/services/powersync/online-guard.test.ts app/src/services/powersync/first-sync.test.ts app/src/services/powersync/schema.test.ts app/src/services/powersync/local-reads.test.ts app/src/services/powersync/maneuver-reads.test.ts app/src/services/powersync/upload.test.ts app/src/services/powersync/upload-rejections.test.ts app/src/utils/maneuver-gating.test.ts app/src/utils/maneuver-gating-load.test.ts app/src/utils/maneuver-config.test.ts app/src/utils/maneuver-wizard.test.ts app/src/utils/maniobra-identify.test.ts app/src/utils/maniobra-edge.test.ts app/src/utils/maniobra-listen-state.test.ts app/src/utils/maniobra-resume.test.ts app/src/utils/maneuver-step-kind.test.ts app/src/utils/maneuver-sequence.test.ts app/src/utils/maneuver-category-preview.test.ts app/src/utils/maneuver-event-query.test.ts app/src/utils/maneuver-skip.test.ts app/src/utils/maneuver-applicability.test.ts app/src/utils/vaccine-checklist.test.ts app/src/utils/repro-status.test.ts app/src/utils/lote-picker.test.ts app/src/utils/condition-stepper.test.ts app/src/utils/wheel-picker.test.ts app/src/utils/haptics.test.ts app/src/utils/hero-text-size.test.ts app/src/utils/maneuver-title-size.test.ts app/src/utils/scroll-affordance.test.ts app/src/utils/tab-bar-insets.test.ts app/src/utils/footer-action.test.ts app/src/utils/teeth-options.test.ts app/src/utils/custom-value.test.ts app/src/utils/custom-field.test.ts app/src/utils/custom-render.test.ts app/src/utils/service-months.test.ts app/src/utils/pregnancy-buckets.test.ts app/src/utils/calving-stage.test.ts app/src/utils/reports-format.test.ts app/src/utils/format-date-es-ar.test.ts app/src/services/ble/parser-rs420.test.ts app/src/services/ble/dedup.test.ts app/src/services/ble/contract.test.ts app/src/services/ble/feedback.test.ts app/src/services/ble/adapter-mock.test.ts app/src/services/ble/adapter-web-serial.test.ts app/src/services/ble/wiring.test.ts app/src/services/ble/offline-noread.test.ts app/src/services/ble/listener-gate.test.ts app/src/services/ble/driver-registry.test.ts app/src/services/ble/selection-priority.test.ts app/src/services/ble/adapter-simulator.test.ts app/src/services/ble/demo-gate.test.ts app/src/services/ble/adapter-spp-android.test.ts app/src/features/ble-stick/connection-view.test.ts app/src/utils/import/parse-csv.test.ts app/src/utils/import/parse-sigsa-txt.test.ts app/src/utils/import/breed-senasa.test.ts app/src/utils/import/column-mapping.test.ts app/src/utils/import/normalize-row.test.ts app/src/utils/import/validate-rows.test.ts app/src/utils/import/import-write.test.ts app/src/utils/import/parse-xlsx.test.ts app/src/utils/import/import-ui.test.ts app/src/services/sigsa/sigsa-txt-generator.test.ts app/src/services/sigsa/sigsa-validator.test.ts app/src/services/sigsa/sigsa-export-service.test.ts app/src/utils/sigsa-display.test.ts app/src/utils/breed-picker.test.ts app/src/utils/renspa-validate.test.ts app/src/utils/sigsa-filters.test.ts`,
);
...
if (process.env.SUPABASE_SERVICE_ROLE_KEY) {
  ...
  run('User_private suite (spec 14 + delta TELÉFONO)', `node --test supabase/tests/user_private/run.cjs`);
