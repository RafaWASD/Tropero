...
- [x] **F4** — Deploy: PASO 1 (frontend + schema PowerSync) + PASO 2 (migración `0122` por MCP, **autorizado por Raf**) hechos + verificados (estructural 7/7 + grants 7/7). PowerSync `mitropero.yaml` usa `SELECT *` → tolera el drop de columna, sin edit.
